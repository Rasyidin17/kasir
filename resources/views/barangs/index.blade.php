        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('barangs.create') }}">Tambah Barang</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('barangs.destroy',$barang->id) }}" method="POST">
                                ...
                                <a class="btn btn-info" href="{{ route('barangs.show',$barang->id) }}">
                                ...
                                <a class="btn btn-primary" href="{{ route('barangs.edit',$barang->id) }}">
