...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('distributors.create') }}">Tambah Distributor</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              <div class="card">
                ...
                <table id="example" class="table table-hover table-bordered data-table text-nowrap">
                    ...
                    <tr>
                        <td>{{ ++$i }}</td>
                        <td>{{ $distributor->n_dist }}</td>
                        <td>{{ $distributor->n_rek }}</td>
                        <td>{{ $distributor->alamat }}</td>
                        <td>{{ $distributor->no_tlp }}</td>
                        <td>
                            <form action="{{ route('distributors.destroy',$distributor->id) }}" method="POST">
               
                                <a class="btn btn-info" href="{{ route('distributors.show',$distributor->id) }}">
  ...
  {!! $distributors->withQueryString()->links('pagination::bootstrap-5') !!}
  @endsection